...
import { Text,View,StyleSheet,ImageBackground,StatusBar,SafeAreaView,Platform,Alert,Image } from "react-native";
                    ...
                    <View style={styles.mapContainer}>
                        ...
                        >
                          <Marker coordinate={{latitude:this.state.location.latitude,
                            longitude:this.state.location.longitude,}}>
                                <Image source={issicon} style={{height:50,width:50}}/>
                                </Marker>  
                        </MapView>
